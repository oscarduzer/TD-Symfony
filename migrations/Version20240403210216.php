 ...
 */
final class Version20240403210216 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE marche (id INT NOT NULL, id_ville_id INT NOT NULL, id_marche INT SERIAL NOT NULL, nom_marche VARCHAR(140) NOT NULL, description TEXT NOT NULL, capacite INT NOT NULL, adresse VARCHAR(150) NOT NULL, telephone VARCHAR(40) NOT NULL, image VARCHAR(170) NOT NULL, PRIMARY KEY(id))');
